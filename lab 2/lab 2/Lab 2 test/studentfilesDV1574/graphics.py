...
#        no longer necessary. Its default is >>> entry = Entry(Point(50, 50), 20) # An input field width 20 characters.now False (off). It may
...
#        to happen during idle periods or when flush is called.x = [3]
# Version 2.0
